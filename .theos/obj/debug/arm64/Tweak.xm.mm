...
__unused static uint32_t (*_logos_orig$_ungrouped$notify_post)(const char *name); __unused static uint32_t _logos_function$_ungrouped$notify_post(const char *name) {
    uint32_t r = _logos_orig$_ungrouped$notify_post(name);
...
__unused static void (*_logos_orig$_ungrouped$CFNotificationCenterPostNotification)(CFNotificationCenterRef center, CFNotificationName name, const void *object, CFDictionaryRef userInfo, Boolean deliverImmediately); __unused static void _logos_function$_ungrouped$CFNotificationCenterPostNotification(CFNotificationCenterRef center, CFNotificationName name, const void *object, CFDictionaryRef userInfo, Boolean deliverImmediately) {
    _logos_orig$_ungrouped$CFNotificationCenterPostNotification(center, name, object, userInfo, deliverImmediately);
...
static __attribute__((constructor)) void _logosLocalCtor_d26df6f8(int __unused argc, char __unused **argv, char __unused **envp) {
    ...
    if(tweakEnabled) {
        {Class _logos_class$_ungrouped$SBMediaController = objc_getClass("SBMediaController"); MSHookMessageEx(_logos_class$_ungrouped$SBMediaController, @selector(init), (IMP)&_logos_method$_ungrouped$SBMediaController$init, (IMP*)&_logos_orig$_ungrouped$SBMediaController$init); MSHookFunction((void *)notify_post, (void *)&_logos_function$_ungrouped$notify_post, (void **)&_logos_orig$_ungrouped$notify_post); MSHookFunction((void *)CFNotificationCenterPostNotification, (void *)&_logos_function$_ungrouped$CFNotificationCenterPostNotification, (void **)&_logos_orig$_ungrouped$CFNotificationCenterPostNotification);}
    }
